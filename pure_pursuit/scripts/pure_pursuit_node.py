...
class PurePursuit(Node):
    ...
    def __init__(self):
        ...
        traj_csv = "good_real_points.csv" #"../../racelines/0425racex_clicked.csv"  #Name of csv in racelines directory
        self.sim_flag = False # Set flag true for simulation, false for real
        self.dual_sim = False # Set flag true for dual simulation, false for single
        ...
        self.k_rrt = 3.0# Curvature Scaling Factor, rrt specific,  smaller makes the curves seem wider and can go faster around
        ...
        if self.dual_sim:
            self.opp_drive_publisher = self.create_publisher(AckermannDriveStamped, 'opp_drive', 1)
        ...
        self.goal_points = load_from_csv(traj_csv, clicked=True, scaler=1)
    ...
    def pose_callback(self, pose_msg):
        ...
        msg.drive.speed = 2.0 #float(drive_speed)###CHANGE THIS BACK, IN SIM THE CHANGING VELOCITY WAS CAUSING PROBLEMS
        msg.drive.steering_angle = float(steering_angle)
        self.drive_publisher.publish(msg)
        if self.dual_sim:
            msg.drive.speed=0.0
            msg.drive.steering_angle=0.0
            self.opp_drive_publisher.publish(msg)
